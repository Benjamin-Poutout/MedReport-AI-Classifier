...
filenames = ['chain_of_thought_command_r_35B_gen.csv', 'chain_of_thought_llama_8B_gen.csv', 'chain_of_thought_llama_3_70B_gen.csv', 'chain_of_thought_command_r_plus_gen.csv']
modeles = ['Command-R-35B', 'Llama-3-8B', 'Llama-3-70B', 'Command-R-plus-4bit']
